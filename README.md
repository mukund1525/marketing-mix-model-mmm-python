...
Model validation (MAE, RMSE, R² – directional use)

Contribution & ROI calculation
...
Note: In MMM, directional accuracy and interpretability are prioritised over predictive R².
